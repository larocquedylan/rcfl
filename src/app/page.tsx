...
export default function Home() {
  return (
    <main className='flex flex-col items-center justify-between min-h-screen p-24'>
      <div className='z-10 items-center justify-between w-full max-w-5xl font-mono text-sm lg:center'>
        <p className='fixed top-0 left-0 flex justify-center w-full pt-8 pb-6 border-b border-gray-300 bg-gradient-to-b from-zinc-200 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30'>
          Coming Soon&nbsp;
          <code className='font-mono font-bold'>River City Leaders Forum</code>
        </p>
      ...
      <div className='grid mb-32 text-center lg:mb-0 lg:grid-cols-2 lg:text-left'>
        {/* <a
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Find in-depth information about RCLF and our mission.
          </p>
        </Link> */}
        {/* </a> */}
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Contact us to learn more about RCLF.
          </p>
        </a> */}
